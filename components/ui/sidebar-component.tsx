    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-[sans-serif] text-[16px] text-neutral-50">
            Interfaces
          </div>
        </div>
      </div>
  ...
  if (isCollapsed) {
    return (
      <div className="w-full flex justify-center transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
        ...
        >
          <span className="inline-block rotate-185">
    ...
    <div className="w-full overflow-hidden transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div className="font-sans font-semibold text-[18px] text-neutral-50 leading-[27px]">
              {title}
            </div>
          </div>
        </div>
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="font-sans text-[14px] text-neutral-50">Text content</div>
            <button
              type="button"
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ transitionTimingFunction: softSpringEasing }}
        >
          <div className="font-sans text-[14px] text-neutral-50 leading-[20px] truncate">
            {item.label}
          </div>
        </div>
...
function SubMenuItem({ item, onItemClick }: { item: MenuItemT; onItemClick?: () => void; key?: string | number }) {
  return (
    <div className="w-full pl-9 pr-1 py-[1px]">
      ...
      >
        <div className="flex-1 min-w-0">
          <div className="font-sans text-[14px] text-neutral-300 leading-[18px] truncate">
            {item.label}
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-col w-full">
      ...
      >
        <div className="flex items-center h-10 px-4">
          <div className="font-sans text-[14px] text-neutral-400">
            {section.title}
          </div>
        </div>
      </div>
...
export function Frame760() {
  return (
    <div className="bg-[#1a1a1a] min-h-[840px] flex items-center justify-center p-4 rounded-3xl overflow-hidden shadow-2xl">
      <TwoLevelSidebar />
    </div>
  );
}
